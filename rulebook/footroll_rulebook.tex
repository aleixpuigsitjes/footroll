...
\geometry{margin=1in}
\setlist{leftmargin=*}
\newcommand{\RulebookImage}[2][0.85\textwidth]{%
  \begin{figure}[h]
    \centering
    \includegraphics[width=#1]{#2}
  \end{figure}}
\newcommand{\RulebookInlineImage}[2][0.3\textwidth]{%
  \includegraphics[width=#1]{#2}}
\begin{document}

\section{\textbf{FOOTROLL}}

\textbf{Rulebook}

\section{\textbf{(advanced edition)}}

\subsection{0.12.1 (beta)}

\RulebookImage{images/image15.png}


\RulebookImage{images/image9.png}


\paragraph{\underline{\href{https://www.google.com/url?q=https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode&sa=D&source=editors&ust=1763256892399332&usg=AOvVaw1kUUHriWW4eqgoNTEEr9D4}{Attribution-NonCommercial-ShareAlike 4.0 International }}}

\paragraph{\underline{\href{https://www.google.com/url?q=https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode&sa=D&source=editors&ust=1763256892399696&usg=AOvVaw3tIlzYBvhNekEpa5yruDMP}{(CC BY-NC-SA 4.0)}}}

\section{\textbf{Created by Aleix Puig Sitjes}}

\section{\textbf{aleix.puig@gmail.com}\bigskip\hrule\bigskip}
